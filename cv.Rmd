...
GitLab: [jfisher](https://code.usgs.gov/jfisher)&nbsp;
GitHub: [jfisher-usgs](https://github.com/jfisher-usgs)

### Contact

- Email: <stormplot@gmail.com>
- Telephone: 209-261-2905

### Employment

- Lead Programmer, U.S. Geological Survey (USGS) AQUARIUS Samples Integration Project ([ASIP](https://doimspp.sharepoint.com/sites/usgs-portal/collaboration/sites/NWIS/Discrete-Samples/SitePages/Visitors%20Home.aspx)), Python and R Tools (PyRT) Team, October 2020 to present (20 hours per week). Responsible for making technology choices, architectural decisions, and system design for the Discrete Sample Extensibility Tools (DSET). The DSET team develops and maintains a suite of R packages designed to integrate with the third-party AQUARIUS Samples API ([Aquatic Informatics](https://aquaticinformatics.com/)). These enterprise-grade tools enable efficient input and output of over 144 million discrete water data records, while supporting robust quality control and analysis. Additionally, I mentor a team of five programmers to foster growth and collaboration.
- Hydrologist, USGS Idaho Water Science Center, Idaho National Laboratory Project Office ([INLPO](https://www.usgs.gov/centers/id-water/science/idaho-national-laboratory-project-office)), October 2008 to present (transitioned to 20 hours per week in October 2020). Responsibilities include groundwater flow and contaminant transport modeling, optimizing long-term monitoring networks, and analyzing water-quality characteristics and trends. Additionally, I mentor a team of four programmers, fostering collaboration and technical growth. Public R packages developed and maintained by INLPO are available on [GitLab](https://code.usgs.gov/inl).
- Research Engineer, University of California, Los Angeles (UCLA) Center for Embedded Networked Sensing ([CENS](https://research.cens.ucla.edu/)), January to October 2008. Research and lecturing duties.
- Project Scientist, University of California, Merced (UCM), January 2007 to January 2008. Research and lecturing duties.
- Contractor, American Institute of Biological Sciences, National Ecological Observatory Network ([NEON](https://www.neonscience.org/)) group. January 2005 to October 2008, about 1 hour per week. Responsible for graphic design services.
- Postdoctoral Scholar, Department of Engineering, UCM, January 2004 to January 2008. Research and lecturing duties.
- Graduate Research Assistant, Department of Civil and Environmental Engineering, UCLA, January 2002 to January 2004, 20 hours per week. Research duties.
- Teaching Assistant, Department of Civil and Environmental Engineering, UCLA, January 2001 to January 2002, 20 hours per week. Assisted students.
- Computer Programmer, U.S. Forest Service, Pacific Southwest Research Station, Redwood Sciences Laboratory ([RSL](https://www.fs.fed.us/psw/locations/arcata/index.shtml)), January 2000 to January 2002, 20 hours per week. Data processing duties.
- Hydrologic Technician, U.S. Forest Service, Pacific Southwest Research Station, RSL, January 1997 to January 2000, 20 hours per week. Data processing duties.

### Education

- Ph.D. in Civil Engineering, [UCLA](https://www.cee.ucla.edu/),
...
- M.S. in Environmental Systems, Humboldt State University
  ([HSU](https://engineering.humboldt.edu/)), environmental resources
...
- Engineer-In-Training, [FE exam](https://ncees.org/engineering/fe/),
...
- **Fisher, J.C.**, 2022,
  ...
  U.S. Geological Survey software release, R package, Reston, Va., <https://doi.org/10.5066/P9I3GWWU>.
- **Fisher, J.C.**, 2021, ObsNetQW—Assessment of a water-quality aquifer monitoring network:
  U.S. Geological Survey software release, R package, Reston, Va., <https://doi.org/10.5066/P9X71CSU>.
- **Fisher, J.C.**, Bartholomay, R.C., Rattray, G.W., and Maimer, N.V., 2021,
  ...
  U.S. Geological Survey Scientific Investigations Report 2021-5031 (DOE/ID-22252), 63 p.,
...
- Twining, B.V., Bartholomay, R.C., **Fisher, J.C.**, and Anderson, C., 2021,
  ...
  and chemical constituents in the eastern Snake River Plain aquifer, Idaho National Laboratory, Idaho,
  2014u201318: U.S. Geological Survey Scientific Investigations Report 2021u20135002, 82 p.,
...
- Bartholomay, R.C., Maimer, N.V., Rattray, G.W., and **Fisher, J.C.**, 2020,
  ...
  Eastern Snake River Plain Aquifer and perched groundwater zones, Idaho National Laboratory, Idaho,
  emphasis 2016–18: U.S. Geological Survey Scientific Investigations Report 2019–5149 (DOE/ID–22251), 82 p.,
...
- **Fisher, J.C.**, 2020,
  ...
  U.S. Geological Survey software release, R package, Reston, Va., <https://doi.org/10.5066/P9PP9UXZ>.
...
- **Fisher, J.C.**, Bartolino, J.R., Wylie, A.H., Sukow, Jennifer, and
  ...
  <https://doi.org/10.3133/sir20165080>.
...
- **Fisher, J.C.**, 2013, Optimization of water-level monitoring networks in the
  ...
  [news](https://www.circleofblue.org/2013/world/moneyball-for-groundwater-monitoring-networks/).
...
- INL Monitoring and Surveillance Committee Meeting, Idaho Falls, ID, June 22, 2022,
  Assessing the efficacy and appropriateness of an existing water-quality aquifer monitoring network.
- Technical Architecture Review Board (TARB), May 20, 2022,
  Application design assessment for the Discrete Sample Extensibility Tools (DSET) project.
- USGS Water Missing Area Seminar Series, Feb. 2, 2022,
  Assessing the efficacy and appropriateness of an existing water-quality aquifer monitoring network,
  [intranet](https://water.usgs.gov/usgs/wma_seminar_series/fisher-020222.mp4).
- Idaho Water Quality Workshop,
  Boise, ID, Jan. 27, 2021,
  Optimization of the Idaho National Laboratory Water-Quality Aquifer Monitoring Network.
- Wood River Valley groundwater-flow model training workshop,
  organized by the USGS Idaho Water Science Center
  and the Idaho Department of Water Resources ([IDWR](https://idwr.idaho.gov/)),
...
- The R User Conference ([useR!](https://user2016.r-project.org/)),
...
- Idaho State University ([ISU](https://isu.edu/geosciences/)) Department of
...
- American Water Resources Association ([AWRA](https://www.awra.org/)) Summer
